      ...
      <Timeline position="alternate-reverse">
        <TimelineItem>
          ...
          <TimelineContent className="flex flex-col items-end justify-end py-8">
            ...
            <Typography className="  hidden  w-1/2 text-white md:block">
              Instrutores experientes capacitam sua equipe cpara enfrentar os
              desafios do mercado, garantindo crescimento e sucesso contínuos.
            </Typography>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
          ...
          <TimelineContent className="py-5 md:py-7">
            ...
            <Typography className="hidden w-1/2 text-white md:block">
              A Go Up oferece um Sistema Multisserviços que atende a todas as
              necessidades do seu negócio em um só lugar.
            </Typography>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
          ...
          <TimelineContent className="flex flex-col items-end justify-end py-8">
            ...
            <Typography className=" hidden  w-1/2 text-white md:block">
              Tecnologias avançadas de criptografia e protocolos de segurança
        ...
        <TimelineItem>
          ...
          <TimelineContent className=" py-8">
            ...
            <Typography className="hidden  w-1/2 text-white md:block">
              A Go Up evolui constantemente para atender às suas necessidades em
              constante mudança.
            </Typography>
          </TimelineContent>
        </TimelineItem>
