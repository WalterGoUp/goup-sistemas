          ...
          >
            <div className="relative grid grid-cols-2">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                >
                  Nosso sistema oferece uma solução completa e abrangente. Com
                  todas as ferramentas necessárias para a gestão de notas
                  fiscais, controle de vendas e muito mais.
                </h3>
          ...
          >
            <div className=" flex flex-col items-center justify-center  md:w-1/2  ">
              ...
              <h2
                className={`${rubik.className} text-extrabold hidden  pt-10 text-xl text-white md:block`}
              >
                Seja qual for a sua necessidade, estamos prontos para superar as
                expectativas e garantir que você tenha a melhor experiência
                possível. Seu sucesso é o nosso compromisso.
              </h2>
              <div className="flex justify-center pt-5">
                <Link
                  href="https://api.whatsapp.com/send?phone=32999245031&text=Olá, gostaria de saber mais sobre a Go Up!"
            ...
            <div className="grid grid-cols-2">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <h3
                  className={`${rubik.className} text-extrabold hidden pt-10  text-xl text-white md:block`}
                >
                  Estamos dedicados a superar as expectativas, ouvir atentamente
                  suas necessidades e trabalhar incansavelmente para garantir o
                  seu sucesso.
                </h3>
                <div className="flex justify-center pt-5">
                  <Link
