            ...
            <div className="grid gap-4 p-10 md:grid-cols-2">
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Veja a Diferença na Gestão de Óticas
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Melhore significativamente a administração de óticas e garanta a total satisfação do
                            cliente. Nossa plataforma oferece recursos para o rastreamento de produtos, agendamento
                            eficiente e atendimento de qualidade excepcional. Otimize sua ótica com facilidade e ofereça
                            aos seus clientes uma experiência sem igual. Com nosso sistema, você terá o controle
                            completo das operações para se destacar no mercado de óticas.
                        </Typography>
                    </div>
                    <div className="flex justify-center pt-5">
                        <Link
                            ...
                            <Button
                                variant="outlined"
                                className={` ${rubik.className} px:4 flex  items-center gap-3 rounded-2xl border-none bg-[#391a7d] font-bold   text-white
