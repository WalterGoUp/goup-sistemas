                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Melhore significativamente a administração de óticas
                            e garanta a total satisfação do cliente. Nossa
                            plataforma oferece recursos para o rastreamento de
                            produtos, agendamento eficiente e atendimento de
                            qualidade excepcional. Otimize sua ótica com
                            facilidade e ofereça aos seus clientes uma
                            experiência sem igual. Com nosso sistema, você terá
                            o controle completo das operações para se destacar
                            no mercado de óticas.
                        </Typography>
                    </div>
