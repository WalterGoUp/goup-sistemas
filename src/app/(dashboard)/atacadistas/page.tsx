            ...
            <div className=" flex justify-center bg-gradient-to-br from-[#391a7d] to-[#58167d]">
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        ...
                        >
                            Transforme sua operação atacadista com nosso sistema
                            simplificado
                        </h2>
                    </div>
                </div>
                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Descubra como nossa solução especializada pode
                            transformar a gestão de atacadistas, otimizando
                            operações e aumentando lucratividade. Simplifique o
                            controle de estoque, gerencie fornecedores com
                            facilidade e eleve a experiência do cliente. Com
                            nossa plataforma, você terá acesso a análises
                            detalhadas para tomar decisões estratégicas
                            informadas e garantir a liderança no competitivo
                            mercado de atacado.
                        </Typography>
                    </div>
