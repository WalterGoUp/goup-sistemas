...
export default function Atacadistas() {
    return (
        <div>
                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        <h1
                            ...
                            Elevando a Eficiência nos Atacadistas
                        </h1>
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-white md:text-xl `}>
                            Transforme sua operação atacadista com nosso sistema simplificado
                        </h2>
                    </div>
                </div>
            </div>
            <div className="grid gap-4 p-10 md:grid-cols-2">
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Revolucione a Gestão no Setor de Atacado
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Descubra como nossa solução especializada pode transformar a gestão de atacadistas,
                            otimizando operações e aumentando lucratividade. Simplifique o controle de estoque, gerencie
                            fornecedores com facilidade e eleve a experiência do cliente. Com nossa plataforma, você
                            terá acesso a análises detalhadas para tomar decisões estratégicas informadas e garantir a
                            liderança no competitivo mercado de atacado.
                        </Typography>
                    </div>
