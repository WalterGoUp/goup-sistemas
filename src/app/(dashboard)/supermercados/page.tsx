                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Alcance o auge de eficiência nas operações de
                            supermercados. Controle de estoque, gestão de
                            fornecedores simplificada e um novo patamar de
                            qualidade. Descubra como nossa plataforma pode
                            elevar a experiência do cliente, garantindo que seus
                            clientes tenham acesso a produtos de qualidade de
                            maneira eficaz e eficiente. Simplifique a gestão no
                            setor de supermercados com a nossa solução de alto
                            desempenho.
                        </Typography>
                    </div>
