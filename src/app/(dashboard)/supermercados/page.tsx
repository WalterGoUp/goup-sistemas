                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        <h1
                            ...
                            Desempenho Superior para Supermercados
                        </h1>
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-white md:text-xl `}>
                            Soluções para supermercados que simplificam a gestão
                        </h2>
                    </div>
                </div>
            </div>
            <div className="grid gap-4 p-10 md:grid-cols-2">
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Supermercados: Gerenciamento de Alto Desempenho
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Alcance o auge de eficiência nas operações de supermercados. Controle de estoque, gestão de
                            fornecedores simplificada e um novo patamar de qualidade. Descubra como nossa plataforma
                            pode elevar a experiência do cliente, garantindo que seus clientes tenham acesso a produtos
                            de qualidade de maneira eficaz e eficiente. Simplifique a gestão no setor de supermercados
                            com a nossa solução de alto desempenho.
                        </Typography>
                    </div>
