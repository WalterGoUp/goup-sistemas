                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        <h1
                            ...
                            Bem-Estar e Desempenho com Nosso Sistema
                        </h1>
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-xl text-white `}>
                            Gestão eficaz para academias e clubes
                        </h2>
                    </div>
                </div>
            </div>
            <div className="grid  gap-4 p-10 md:grid-cols-2">
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Bem-Estar e Eficiência para Academias e Clubes
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Simplifique a administração de academias e clubes de saúde para elevar o bem-estar e a
                            eficiência. Aperfeiçoe procedimentos, produtos e serviços com nosso sistema de gestão.
                            Descubra como pode ajudar seus clientes a alcançarem seus objetivos de saúde e forma física
                            de maneira eficaz e simplificada.
                        </Typography>
                    </div>
