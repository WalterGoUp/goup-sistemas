            ...
            <div className=" flex justify-center bg-gradient-to-br from-[#391a7d] to-[#58167d]">
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        ...
                        <h2
                            className={`${rubik.className} text-bold font-700 pt-5 text-center text-xl text-white `}
                        >
                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Simplifique a administração de academias e clubes de
                            saúde para elevar o bem-estar e a eficiência.
                            Aperfeiçoe procedimentos, produtos e serviços com
                            nosso sistema de gestão. Descubra como pode ajudar
                            seus clientes a alcançarem seus objetivos de saúde e
                            forma física de maneira eficaz e simplificada.
                        </Typography>
                    </div>
