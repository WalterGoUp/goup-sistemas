                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Simplifique a administração no campo com nosso
                            sistema especializado. Reduza falhas, aumente a
                            eficiência e mantenha o controle sólido de todas as
                            operações. Descubra como nossas soluções podem
                            ajudar produtores rurais a obterem resultados
                            excepcionais, garantindo uma produção eficiente e de
                            alta qualidade. Com nossas soluções, a gestão no
                            setor rural se torna mais simples e produtiva.
                        </Typography>
                    </div>
