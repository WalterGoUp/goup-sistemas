                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        <h1
                            ...
                            Colheita de Eficiência para Produtores Rurais
                        </h1>
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-white md:text-xl `}>
                            Gerenciamento simplificado para o campo e além
                        </h2>
                    </div>
                </div>
            </div>
            <div className="grid gap-4 p-10 md:grid-cols-2">
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Produtor Rural: Gestão Simplificada e Produtiva
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Simplifique a administração no campo com nosso sistema especializado. Reduza falhas, aumente
                            a eficiência e mantenha o controle sólido de todas as operações. Descubra como nossas
                            soluções podem ajudar produtores rurais a obterem resultados excepcionais, garantindo uma
                            produção eficiente e de alta qualidade. Com nossas soluções, a gestão no setor rural se
                            torna mais simples e produtiva.
                        </Typography>
                    </div>
