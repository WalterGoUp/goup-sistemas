                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        ...
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-white md:text-xl `}>
                            Combine recursos para assegurar um desempenho superior!
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            As indústrias confiam no <strong>GoUp</strong> para aprimorar suas operações de produção e
                            logística. Nossa plataforma oferece recursos de controle de produção, gestão de fornecedores
                            e rastreabilidade de produtos, que ajudam a garantir a qualidade e a eficiência em cada
                            etapa. Além disso, o <strong>GoUp</strong> oferece análises detalhadas para respaldar
                            decisões estratégicas. Com nosso sistema, você pode otimizar suas operações industriais e
