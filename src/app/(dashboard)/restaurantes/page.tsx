                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Otimize a gestão em restaurantes, padarias e
                            lanchonetes para oferecer a máxima qualidade.
                            Minimize falhas, aumente a qualidade dos produtos e
                            melhore a experiência dos clientes. Descubra como
                            nossas soluções podem transformar seu negócio,
                            garantindo que a qualidade e a eficiência estejam
                            sempre presentes nos sabores e serviços que você
                            oferece.
                        </Typography>
                    </div>
