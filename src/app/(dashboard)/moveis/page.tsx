            ...
            <div className=" flex justify-center bg-gradient-to-br from-[#391a7d] to-[#58167d]">
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        ...
                        >
                            Gestão transparente para lojas de móveis e
                            eletrodomésticos
                        </h2>
                    </div>
                </div>
                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Ofereça aos clientes uma experiência excepcional em
                            lojas de móveis e eletrodomésticos. Controle o
                            estoque, otimize a gestão e garanta qualidade
                            consistente em todos os produtos. Descubra como
                            nossas soluções podem melhorar sua loja, ajudando
                            você a manter um estoque variado e de alta qualidade
