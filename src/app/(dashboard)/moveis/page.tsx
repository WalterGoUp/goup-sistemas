                ...
                <div className="plano mt-5 h-40  rounded-xl p-5 text-center">
                    <div className=" py-2">
                        <h1
                            ...
                            Móveis e Eletrodomésticos com Qualidade
                        </h1>
                        <h2 className={`${rubik.className} text-bold font-700 pt-5 text-center text-white md:text-xl `}>
                            Gestão transparente para lojas de móveis e eletrodomésticos
                        </h2>
                    </div>
                </div>
            </div>
            <div className="grid gap-4 p-10 md:grid-cols-2">
                ...
                <div className="">
                    <h1 className={`${rubik.className} text-bold font-700 text-center text-2xl md:text-4xl`}>
                        Qualidade e Eficiência em Lojas de Móveis
                    </h1>
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Ofereça aos clientes uma experiência excepcional em lojas de móveis e eletrodomésticos.
                            Controle o estoque, otimize a gestão e garanta qualidade consistente em todos os produtos.
                            Descubra como nossas soluções podem melhorar sua loja, ajudando você a manter um estoque
                            variado e de alta qualidade para atender às necessidades dos clientes de forma eficaz.
                        </Typography>
                    </div>
