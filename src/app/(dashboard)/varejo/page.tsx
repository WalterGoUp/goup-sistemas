                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Obtenha sucesso duradouro no varejo com uma gestão simplificada e altamente eficaz. Aprimore
                            a eficiência da sua loja, mantenha o estoque sob controle e ofereça a melhor experiência
                            possível aos seus clientes. Descubra o potencial do nosso sistema para otimizar todas as
                            operações de varejo, ajudando você a manter seus clientes satisfeitos e alcançar um sucesso
                            excepcional.
                        </Typography>
                    </div>
