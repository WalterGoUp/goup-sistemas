                ...
                <div className="">
                    ...
                    <div className="mt-6 ">
                        <Typography className=" text-justify leading-8">
                            Aperfeiçoe suas operações no setor de materiais de
                            construção com nosso sistema especializado. Reduza
                            erros, otimize o controle de estoque e mantenha um
                            alto padrão de qualidade em todos os produtos.
                            Descubra como podemos simplificar a gestão na
                            construção, desde o controle de estoque até o
                            gerenciamento de fornecedores. Com nossa plataforma,
                            você pode elevar a qualidade e eficiência nas
                            operações de materiais de construção.
                        </Typography>
                    </div>
